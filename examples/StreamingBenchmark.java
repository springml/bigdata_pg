...
PROJECT_ID=myspringml
BUCKET=ini_testing
PIPELINE_FOLDER=gs://ini-staging/dataflow/pipelines/streaming-benchmark
...
mvn compile exec:java \
 -Dexec.mainClass=com.google.cloud.pso.pipeline.StreamingBenchmark \
	...
	-Dexec.args="--project=${PROJECT_ID} \
        ...
        --maxNumWorkers=5 \
        --qps=50000 \
        --schemaLocation=gs://ini-testing/sample-data/game-event-schema.json \
        --topic=projects/myspringml/topics/sjsml"
